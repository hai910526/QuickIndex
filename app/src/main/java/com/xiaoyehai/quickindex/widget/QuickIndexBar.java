package com.xiaoyehai.quickindex.widget;
...
import com.xiaoyehai.quickindex.R;
...
public class QuickIndexBar extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        //背景颜色
        mBgColor = array.getColor(R.styleable.QuickIndexBar_bg_color, Color.parseColor("#e51421"));
